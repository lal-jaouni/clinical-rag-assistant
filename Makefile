...
.PHONY: help install dev-install up down logs health pull-ollama test lint format clean
...
help:
	...
	@echo "  make pull-ollama    Pull the default Ollama LLM (biomistral:7b)"
...
pull-ollama:
	docker exec clinical-rag-ollama ollama pull biomistral:7b
